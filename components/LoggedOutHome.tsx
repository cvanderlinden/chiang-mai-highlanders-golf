...
export default function LoggedOutHome({ onLogin }: LoggedOutHomeProps) {
    ...
    return (
      <div className="flex flex-col items-center justify-center mt-40">
        ...
        />
        <h1
          className="text-2xl sm:text-4xl md:text-6xl text-white"
        ...
        {showLogin && (
          <div className="fixed inset-0 flex items-center justify-center z-20">
            <div
              className={`bg-white p-8 mx-4 sm:mx-6 md:mx-8 rounded-lg shadow-lg max-w-lg w-full transform transition-transform duration-500 ease-out ${isAnimating ? "animate-fade-out-scale" : "animate-fade-in-scale"}`}
            >
